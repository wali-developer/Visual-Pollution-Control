  ...
  return (
    <div className="relative mt-14 flex w-[256px] justify-center rounded-[20px] bg-gradient-to-br from-[#868CFF] via-[#432CF3] to-brand-500 pb-4">
      ...
      <div className="mt-16 flex h-fit flex-col items-center">
        <p className="text-lg font-bold text-white">Visual Pollution Control</p>
        <p className="mt-1 px-4 text-center text-sm text-white">
          The goal of a visual pollution control system is to create a more
          visually appealing and sustainable environment, which can have a
          positive impact on the health and well-being of the area people.
        </p>
      </div>
    </div>
  );
